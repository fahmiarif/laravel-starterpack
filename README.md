...
### Admin Panel
- **User Management** — Full CRUD with role assignment, impersonation, and soft deletes.
- **Role & Permission Management** — Powered by [Spatie Laravel Permission](https://spatie.be/docs/laravel-permission) with grouped permission UI.
- **Dynamic Menu Management** — Drag-and-drop sortable sidebar menus with hierarchical nesting and role-based visibility.

### Developer Experience
- **Type-Safe Frontend** — Strict TypeScript with Zod schema validation and `react-hook-form`.
- **Server State** — `@tanstack/react-query` for all data fetching, caching, and mutations.
- **Auto-Generated Routes** — [Laravel Wayfinder](https://github.com/laravel/wayfinder) eliminates hardcoded URLs.
- **Code Quality** — ESLint, Prettier, Laravel Pint, and Pest testing pre-configured.
...
│   ├── Enums/                  # UserRole enum
│   ├── Http/
│   │   ├── Controllers/Admin/  # UserController, RoleController, MenuController
│   │   ├── Requests/Admin/     # FormRequest validation classes
│   │   └── Resources/Admin/    # Eloquent API Resources
│   ├── Models/                 # User, Menu (UUIDs, SoftDeletes)
│   └── Services/Admin/         # Business logic (UserService, MenuService, etc.)
├── database/
│   ├── migrations/             # Users, permissions, menus, menu_role
│   └── seeders/                # RoleAndPermissionSeeder, MenuSeeder
├── resources/js/
│   ├── components/
│   │   ├── admin/              # MenuFormDialog, RoleFormDialog, UserFormDialog
│   │   └── ui/                 # ShadCN components (Button, Card, Dialog, etc.)
│   ├── hooks/admin/            # React Query hooks (user-hooks, menu-hooks, etc.)
│   ├── layouts/                # AppLayout, AdminLayout
│   ├── pages/
│   │   ├── admin/              # Users, Roles, Menus management pages
│   │   ├── auth/               # Login, Register, etc.
│   │   └── settings/           # Profile & password settings
│   ├── routes/                 # Auto-generated by Wayfinder
│   └── types/admin/            # TypeScript interfaces & Zod schemas
├── routes/
│   ├── web.php                 # Main application routes
│   └── settings.php            # Settings routes
└── vite.config.ts              # Vite + React + Tailwind + Wayfinder
```
...
- **Routing**: Always use Wayfinder — never hardcode URLs.
